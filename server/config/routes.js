...
module.exports = [
  ...
  {method: 'get', path: '/', config: require('../routes/apts/index')},
  ...
  {method: 'post', path: '/apts/{aptId}/occupy', config: require('../routes/apts/occupy')},
  ...
  {method: 'post', path: '/renters/{renterId}/evict', config: require('../routes/renters/evict')},

  {method: 'get', path: '/admin', config: require('../routes/admin/main')}
